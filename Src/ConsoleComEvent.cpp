...
GL::EventMouseFollow::EventMouseFollow(ConsoleUI *consoleUI /*= NULL*/)
{
	setConsoleUI(consoleUI);
}


void EventMouseFollow::onEvent(INPUT_RECORD &input_record)
{
...
EventResizeWindow::EventResizeWindow(ConsoleUI *consoleUI /*= NULL*/)
	: m_dwLast(0)
	, m_dwSpTime(500)
{
	setConsoleUI(consoleUI);
...
void GL::EventResizeWindow::onEvent(INPUT_RECORD &input_record)
{
...
EventDebug::EventDebug(ConsoleUI *consoleUI /*= NULL*/)
{
	setConsoleUI(consoleUI);
...
void GL::EventDebug::onEvent(INPUT_RECORD &input_record)
{
...
void GL::EventDebug::setEvent(DWORD dwEvent)
{
	m_event = dwEvent;
}

void GL::EventDebug::setPosition(int x, int y)
{
	m_rect.X = x;
	m_rect.Y = y;
}
