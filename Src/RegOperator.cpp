...
int strFind(const std::string & str, const std::string & sub, int start = 0, int end = MAX_32BIT_INT)
{
...
std::string strReplace(const std::string & str, const std::string & oldstr, const std::string & newstr, int count = -1)
{
	int sofar = 0;
	int cursor = 0;
	std::string s(str);
